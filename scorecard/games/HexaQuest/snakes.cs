...
public class Snakes : BaseMultiDevice
{
    ...
    public Snakes(GameConfig config, int lavaIntervalp, int lavaDurationp, string ttsCredentialsPath) : base(config)
    {
        this.lavaInterval = lavaIntervalp;
        this.lavaDuration = lavaDurationp;
    }
